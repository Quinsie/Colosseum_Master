...
public class AnimationEventEffects : MonoBehaviour {
    ...
    void InstantiateEffect(int EffectNumber)
    {
        ...
        instance.transform.localScale= Effects[EffectNumber].StartPositionRotation.transform.localScale;
        SoundManager.Instance.SFXPlay("SFX", clips[EffectNumber], Effects[EffectNumber].StartPositionRotation.position);
